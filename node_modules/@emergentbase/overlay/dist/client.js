...
(function () {
  ...
  var BASE = "__EMERGENT_BASE__";
  var HMR_ENABLED = "__EMERGENT_HMR__" === "true";
  var ROOT = "__EMERGENT_ROOT__";
  var RRWEB_MODE = "__EMERGENT_RRWEB_MODE__";
  // "hot" = vite custom-event channel; "http" = token-authenticated POSTs (craco/webpack).
  var TRANSPORT = "__EMERGENT_TRANSPORT__";
  var TOKEN = "__EMERGENT_TOKEN__";
  // The bug FAB is a product surface with its own knob — recording and reporting
  // work headlessly without it.
  var FAB_MODE = "__EMERGENT_FAB__";
  var MAX_ERRORS = 20;
